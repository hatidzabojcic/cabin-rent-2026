...
namespace CabinRent.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260905160106_AddPasswordResetTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CabinRent.Infrastructure.Persistence.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IsActive", "PublishedAtUtc");
            ...
            modelBuilder.Entity("CabinRent.Infrastructure.Persistence.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CabinRent.Infrastructure.Persistence.Reservation", b =>
                {
                    ...
                    b.HasOne("CabinRent.Infrastructure.Persistence.User", "StatusChangedByUser")
                        .WithMany()
